...
@if (session('formid') == 1)
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="branch" class="form-select mb-0" id="gender" aria-label="Gender select example">
    ...
    {{-- add subject --}}
    <div class="card card-body border-0 shadow mb-4">
        <h2 class="h5 mb-4">Add Subject *</h2>
        <form action="{{ route('branchSave') }}" method="POST">
            @csrf
            <input name="key" value="2" hidden>
            <div class="row">
                <div class="col-md-6 mb-3">
                    <div class="col-md-6 mb-3">
                        {{-- <label for="gender">Branch Under</label> --}}
                        ...
                        {{-- <label for="gender">Sub Branch</label> --}}
                    </div>
                    <select name="sub_branch" class="form-select mb-0" id="gender" aria-label="Gender select example">
                        <option selected="">Select Sub Branch</option>
                        @foreach ($subBranch as $subb)
                            <option value="{{ $subb['s_branch'] }}">{{ $subb['sub_name'] }}</option>
                        @endforeach
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div>
                            <input name="subject" class="form-control" id="first_name" type="text"
